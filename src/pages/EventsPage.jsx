    ...
    <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
      ...
      <div className="rounded-[28px] border border-yellow-700/20 bg-[#121c31] p-8 md:p-10">
        ...
        <div className="space-y-5 text-lg leading-relaxed text-slate-300">
          ...
          <p>
            Da li osećam olakšanje ili pritisak?
            Da li mi pomaže ili me ubrzava preko mere?
            Šta se događa sa mojom kreativnošću, načinom rada i osećajem vrednosti?
          </p>
